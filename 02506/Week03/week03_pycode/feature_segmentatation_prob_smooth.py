...
kmeans = sklearn.cluster.MiniBatchKMeans(
    n_clusters=nr_clusters, batch_size=2 * nr_clusters
)
...
features_testing = features_testing.reshape(
    (features_testing.shape[0], features_testing.shape[1] * features_testing.shape[2])
)
labels = training_labels.ravel()
